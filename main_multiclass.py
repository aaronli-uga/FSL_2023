...
LastEditTime: 2023-06-01 15:10:56
...
save_model_path = "saved_models/new_without_snn/"
X_train = np.load('dataset/8cases_jinan/new_training_set/X_train.npy')
y_train = np.load('dataset/8cases_jinan/new_training_set/y_train.npy')
...
# np.save("dataset/8cases_jinan/new_training_set/X_train.npy", X_train)
# np.save("dataset/8cases_jinan/new_training_set/y_train.npy", y_train)
# np.save("dataset/8cases_jinan/new_training_set/X_test.npy", X_test)
# np.save("dataset/8cases_jinan/new_training_set/y_test.npy", y_test)
...
learning_rate = 0.001
num_epochs = 50
history = dict(test_loss=[], test_acc=[], test_f1=[], test_f1_all=[], train_loss=[], train_acc=[], train_f1=[], train_f1_all=[])
